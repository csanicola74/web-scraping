...
page = requests.get('https://www.reddit.com/r/popular/')
...
soup.find_all('div', class_='y8HYJ-y_lTUHkQIc1mdCq _2INHSNB8V5eaWp4P0rY_mE')

# get the programming language from each repo
p_langauge = soup.find_all('span', attrs={'aria-hidden': 'true'})
