...
descriptions_films.find_all(
    'table', {'class': "wikitable"})
for var_films in descriptions_films
print(var_films.text)

descriptions_books.find_all(
    'table', class_='wikitable sortable jquery-tablesorter')
for var_books in descriptions_books
print(var_books.text)
