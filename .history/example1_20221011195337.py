...
page = requests.get(
    'https://www.indeed.com/l-Long-Island,-NY-jobs.html?vjk=50391d8af59670ab')
...
soup.find_all(
    'div', class_='css-901oao r-1nao33i r-a023e6 r-b88u0q r-rjixqe r-1bymd8e r-bcqeeo r-qvutc0')

# get the programming language from each repo
p_langauge = soup.find_all(
    'span', class_='css-901oao css-16my406 r-poiln3 r-bcqeeo r-qvutc0')
# for each item in p_langauge, print the text
for item in p_langauge:
    print(item.text)

<span class = "css-901oao css-16my406 r-poiln3 r-bcqeeo r-qvutc0" > MLB · Trending < /span >
