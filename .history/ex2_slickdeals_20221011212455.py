...
soup.find_all('a', class_='bp-c-card_title bp-c-link')
...
repo_name = soup.find_all('a', class_='bp-c-card_title bp-c-link')
repo_names = []
...
repo_desc = soup.find_all('button', class_='bp-p-storeLink bp-c-linkableButton bp-c-button js-button bp-c-button--link')
repo_descs = []
